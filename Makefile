QUACKERY_VERSION := $(shell cat QUACKERY_VERSION)
QUACKERY_DEPS := $(wildcard QUACKERY_*)
DOCKER_TAG_PREFIX := rzuckerm/quackery:$(QUACKERY_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(QUACKERY_DEPS)
